...
class Piece {
    ...
    public Cavalier cavalier = new Cavalier();
    public Fou fou = new Fou();
    ...
    class Roi implements FDeplacement {
        public ArrayList<Move> pos2(int pos1, String cAd, Board echiquier, boolean dontCallIsAttacked) {
    ...
    class Tour implements FDeplacement {
        public ArrayList<Move> pos2(int pos1, String cAd, Board echiquier, boolean dontCallIsAttacked) {
            ArrayList<Move> liste = new ArrayList<>();
    ...
    class Cavalier implements FDeplacement {
        public ArrayList<Move> pos2(int pos1, String cAd, Board echiquier, boolean dontCallIsAttacked) {
            ArrayList<Move> liste = new ArrayList<>();
    ...
    class Fou implements FDeplacement {
        public ArrayList<Move> pos2(int pos1, String cAd, Board echiquier, boolean dontCallIsAttacked) {
            ArrayList<Move> liste = new ArrayList<>();
    ...
    class Pion implements FDeplacement {
       public ArrayList<Move> pos2(int pos1, String couleur, Board echiquier, boolean dontCallIsAttacked) {
            ArrayList<Move> liste = new ArrayList<>();
